<p align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="./public/static/images/nextpaper-banner-dark.svg">
    <source media="(prefers-color-scheme: light)" srcset="./public/static/images/nextpaper-banner-light.svg">
    <img alt="NextPaper" src="./public/static/images/nextpaper-banner-light.svg" width="760">
  </picture>
</p>
